...
export const VisualizationRenderer: React.FC<Props> = ({ tab, onUpdate, onAdd, isMaximized, onToggleMaximize }) => {
  const content = (() => {
    switch (tab.type) {
      case "chart":
        switch (tab.chartType) {
          case "line": return <LineChartView tab={tab} title={tab.title} isMaximized={isMaximized} onToggleMaximize={onToggleMaximize} />;
          case "column": return <ColumnChartView tab={tab} title={tab.title} isMaximized={isMaximized} onToggleMaximize={onToggleMaximize} />;
          case "bar": return <BarChartView tab={tab} isMaximized={isMaximized} onToggleMaximize={onToggleMaximize} />;
          case "pie": return <PieChartView tab={tab} isMaximized={isMaximized} onToggleMaximize={onToggleMaximize} />;
          case "flow": return <FlowChartView tab={tab} isMaximized={isMaximized} onToggleMaximize={onToggleMaximize} />;
          case "star": return <StarChartView tab={tab} isMaximized={isMaximized} onToggleMaximize={onToggleMaximize} />;
          case "stat": return <StatChartView tab={tab} isMaximized={isMaximized} onToggleMaximize={onToggleMaximize} />;
          case "candlestick": return <CandlestickChartView tab={tab} isMaximized={isMaximized} onToggleMaximize={onToggleMaximize} />;
